...
export default class User {
    ...
    static fromDatabaseResult(databaseResult: any): User {
        try {
            ...
            const { id_telegram, user_telegram, plano, cupom_desconto, nome_completo, telefone, email, forma_de_pagamento, data_assinatura, status_assinatura, dias_ate_fim_assinatura } = databaseResult
